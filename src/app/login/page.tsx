    ...
    <div style={{ height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "var(--bg-gradient-start)" }}>
      <div className="glass-panel" style={{ width: "100%", maxWidth: "450px", padding: "40px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px", margin: "24px 0" }}>
          ...
          <span style={{ color: "var(--text-secondary)", fontSize: "0.8rem", fontWeight: 600 }}>USUARIOS COMUNES</span>
          <div style={{ height: "1px", background: "var(--border)", flex: 1 }}></div>
        </div>

        <button 
          onClick={() => { setLoading(true); signIn("google"); }}
          style={{ width: "100%", padding: "14px", fontSize: "1rem", borderRadius: "12px", border: "1px solid var(--border)", background: "white", color: "#334155", fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", transition: "background 0.2s" }}
